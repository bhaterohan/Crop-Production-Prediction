<%-- 
    Document   : showDriver
    Created on : 21 Jan, 2018, 12:31:59 PM
    Author     : shri
--%>
        ...
        <div class="page-container">
            ...
            <div class="left-content">
                <div class="mother-grid-inner">
                    ...
                    <!--heder end here-->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="home.jsp">Home</a><i class="fa fa-angle-right"></i>Driver <i class="fa fa-angle-right"></i>Show Driver Details</li>
                    </ol>
                    <div class="agile-grids">	
                        <!-- tables -->
                        <%
                            DBConnection db = new DBConnection();
                            String sql = "Select * from tbl_expert";
                            ResultSet rs = db.Select(sql);
                        %>
                        <div class="agile-tables">
                            <div class="w3l-table-info">
                                <h2>Expert Detailas</h2>
                                <table id="table">
                                    <thead>
                                        <tr>
                                            <th>First name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editDriver.jsp?id=<%=rs.getString("id")%>"> <i class="fa fa-edit"></i></a></td>
                                            <td><a href="deleteDriver.jsp?id=<%=rs.getString("id")%>" onclick="if (!confirm('Are you sure?')) {
                                                        return false
