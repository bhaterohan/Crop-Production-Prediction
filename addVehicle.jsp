<%-- 
    Document   : addVehicle
    Created on : 21 Jan, 2018, 1:46:27 PM
    Author     : shri
--%>
        ...
        <div class="page-container">
            ...
            <div class="left-content">
                <div class="mother-grid-inner">
                    ...
                    <!--heder end here-->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="home.jsp">Home</a><i class="fa fa-angle-right"></i>Vehicle <i class="fa fa-angle-right"></i>Add new vehicle</li>
                    </ol>
                    <!--grid-->
                    <div class="validation-system">
                        <div class="validation-form">
                            <!---->
                            <form name="form1" id="form1" action="AddVehicle" method="post" onsubmit="return myValidation()">
                                <div class="vali-form">
                                    <div class="col-md-6 form-group1">
                                        <label class="control-label">Vehicle ID</label>
                                        <input type="text" placeholder="Vehicle ID" name="vehicleid" id="vehicleid" required="Vehicle ID">
                                    </div>
                                    <div class="col-md-6 form-group1 form-last">
                                        <label class="control-label">Vehicle Number</label>
                                        <input type="text" placeholder="Vehicle Number" name="vnumber" id="vnumber" required="Vehicle Number" >
                                    </div>
                                ...
                                <div class="vali-form">
                                    <div class="col-md-6 form-group1">
                                        ...
                                        <input type="text" placeholder="Vehicle type" name="type" id="type" required="Vehicle Type">
                                    </div>
                                    <div class="clearfix"> </div>
                                </div>
